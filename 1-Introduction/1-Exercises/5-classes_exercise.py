...
def get_april_birthdays(people):
    ...
    for person in people:
        if person.birthday_month == 'April':
            april_birthdays.update({person.name:person.age+1})
...
def get_most_common_month(people):
    ...
    for person in people:
        ...
        if months[person.birthday_month] > max_month_rep:
            max_month_rep = months[person.birthday_month]
            max_month_name = person.birthday_month
