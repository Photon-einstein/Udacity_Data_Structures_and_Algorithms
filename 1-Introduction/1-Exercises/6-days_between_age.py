def save_dates_in_tuple_in_ascending_order(
    minor_date_list, greater_date_list, year1, month1, day1, year2, month2, day2
):
...
def get_minor_date(year1, month1, day1, year2, month2, day2):
    ...
    if year1 < year2:
        ...
        save_dates_in_tuple_in_ascending_order(
            minor_date_list, greater_date_list, year1, month1, day1, year2, month2, day2
        )
    elif year1 > year2:
        # date 1 is greater than date 2
        save_dates_in_tuple_in_ascending_order(
            minor_date_list, greater_date_list, year2, month2, day2, year1, month1, day1
        )
    else:
...
def daysBetweenDates(year1, month1, day1, year2, month2, day2):
    ...
    delta_days = 0
    while (
        minor_date_tuple[0][0]["year"] != minor_date_tuple[1][0]["year"]
        or minor_date_tuple[0][1]["month"] != minor_date_tuple[1][1]["month"]
        or minor_date_tuple[0][2]["day"] != minor_date_tuple[1][2]["day"]
    ):
        # advance only days
        if (
            minor_date_tuple[0][0]["year"] == minor_date_tuple[1][0]["year"]
            and minor_date_tuple[0][1]["month"] == minor_date_tuple[1][1]["month"]
        ):
        ...
        # advance month
            ...
            if minor_date_tuple[0][1]["month"] == 2:
                ...
                months_day[2] = (
                    29 if check_leap_day(minor_date_tuple[0][0]["year"]) else 28
                )

            delta_days += (
                months_day[minor_date_tuple[0][1]["month"]]
                - minor_date_tuple[0][2]["day"]
            )
